...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
         ...
         */
        public AndroidxFoundationLibraryAccessors getFoundation() { return laccForAndroidxFoundationLibraryAccessors; }
    ...
    public static class AndroidxFoundationLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxFoundationLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAndroid() { return create("androidx.foundation.android"); }

        /**
         * Returns the group of libraries at androidx.foundation.layout
         */
        public AndroidxFoundationLayoutLibraryAccessors getLayout() { return laccForAndroidxFoundationLayoutLibraryAccessors; }
    ...
    public static class AndroidxFoundationLayoutLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxFoundationLayoutLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getAndroid() { return create("androidx.foundation.layout.android"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: foundationAndroid (1.7.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: foundationLayoutAndroid (1.7.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: uiToolingPreviewAndroid (1.7.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
